...
public class ExArcBalanceFuncStkWba {
	...
	private Integer balance_function_id;
	private String balance_function_name;
	private String bill_dtl_tablename;
	private Integer aval_qty_sign;
	private Integer lock_qty_sign;
	private Integer physic_qty_sign;
	private Integer virtual_qty_sign;
	private Integer fact_virtual_qty_sign;
	private Integer reserved_qty_sign;
	private String aval_qty;
	private Integer canbenegative;
	...
	public Integer getBalance_function_id() {
		return balance_function_id;
	}

	public void setBalance_function_id(Integer balance_function_id) {
	...
	public Integer getAval_qty_sign() {
		return aval_qty_sign;
	}

	public void setAval_qty_sign(Integer aval_qty_sign) {
		this.aval_qty_sign = aval_qty_sign;
	}

	public Integer getLock_qty_sign() {
		return lock_qty_sign;
	}

	public void setLock_qty_sign(Integer lock_qty_sign) {
		this.lock_qty_sign = lock_qty_sign;
	}

	public Integer getPhysic_qty_sign() {
		return physic_qty_sign;
	}

	public void setPhysic_qty_sign(Integer physic_qty_sign) {
		this.physic_qty_sign = physic_qty_sign;
	}

	public Integer getVirtual_qty_sign() {
		return virtual_qty_sign;
	}

	public void setVirtual_qty_sign(Integer virtual_qty_sign) {
		this.virtual_qty_sign = virtual_qty_sign;
	}

	public Integer getFact_virtual_qty_sign() {
		return fact_virtual_qty_sign;
	}

	public void setFact_virtual_qty_sign(Integer fact_virtual_qty_sign) {
		this.fact_virtual_qty_sign = fact_virtual_qty_sign;
	}

	public Integer getReserved_qty_sign() {
		return reserved_qty_sign;
	}

	public void setReserved_qty_sign(Integer reserved_qty_sign) {
	...
	public Integer getCanbenegative() {
		return canbenegative;
	}

	public void setCanbenegative(Integer canbenegative) {
